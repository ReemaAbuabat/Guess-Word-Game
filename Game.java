...
public class Game {
	...
	/**
	 * The main method of the program that reads player's information, connect it to
	 * the game, generates the word, and starts the playing.
	 * 
	 * @param args
	 */
	...
	/**
	 * Called by the main, the engine of the game that consciously reads player's
	 * guesses and calls GuessWord methods.
	 */
	public static void play() {
		...
		while (!gw.isWinner() && !gw.isLoser()) {
			...
			// Check if the entered character is a ?
               ...
               catch(NumberExceededException e)
               {  
                 ...
                 try{
                    throw new InputMismatchException("Error:you entered incorrect character");
